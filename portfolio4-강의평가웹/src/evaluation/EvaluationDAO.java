...
public class EvaluationDAO {
	public int write(EvaluationDTO evaluationDTO) {
		...
		try {
			...
			pstmt.setString(10, evaluationDTO.getLectureFaculty());
			pstmt.setString(11, evaluationDTO.getCreditProportion());
			pstmt.setString(12, evaluationDTO.getReportVolume());
	...
	public ArrayList<EvaluationDTO> getList(String lectureDivide,String searchType,String search,int pageNumber){
		...
		try {
			...
			*/
			SQL="SELECT * FROM EVALUATION WHERE CONCAT(lectureName,professorName,evaluationTitle,evaluationContent) LIKE ? ORDER BY evaluationID DESC LIMIT "+ pageNumber * 5 + ", " + pageNumber * 5 + 6;
