...
<%
	...
	System.out.println("평가 사이즈 : "+evaluationList.size());
		...
		<div class="card-body">
			...
			<div class="row">
				<div class="col-9 text-left">
					...
					강의력: <span style="color : red;"><%= evaluation.getLectureFaculty() %></span>
					학점비율: <span style="color : red;"><%= evaluation.getCreditProportion() %></span>
					과제양: <span style="color : red;"><%= evaluation.getReportVolume() %></span>
					<span style="color : green;">(추천 : <%= evaluation.getLikeCount() %>)</span>
				</div>
				<div class="col-3 text-right">
					<a onclick="return confirm('추천')" href="likeAction.jsp?evaluationID=">추천</a>
					<a onclick="return confirm('삭제')" href="deleteAction.jsp?evaluationID=">삭제</a>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="modal-body">
					<form action="evaluationRegisterAction.jsp" method="post">
						...
						<div class="form-row">
							...
							<div class="form-group col-sm-4">
								...
								<select name="semesterDivide" class="form-control">
									...
									<option value="여름 계절 학기" >여름계절 학기</option>
									<option value="2학기" >2학기</option>
									<option value="겨울 계절 학기" >겨울계절 학기</option>
								</select>
							</div>
							<div class="form-group col-sm-4">
								<label>강의 구분</label>
						...
						<div class="form-row">
							...
							<div class="form-group col-sm-3">
								<label>강의력</label>
								<select name="lectureFaculty" class="form-control">
									<option value="A">매우 뛰어남</option>
									<option value="B">보통</option>
									<option value="C">필수라서 듣는다</option>
									<option value="F">집에서 혼자하자</option>
								</select>
							</div>
							<div class="form-group col-sm-3">
								<label>학점 비율</label>
								<select name="creditProportion" class="form-control">
									<option value="A">A폭격기</option>
									<option value="B">보통</option>
									<option value="C">C뿌리기 장인</option>
									<option value="F">F폭격기</option>
								</select>
							</div>
							<div class="form-group col-sm-3">
								<label>과제양</label>
								<select name="reportVolume" class="form-control">
									<option value="A">하루면 끝</option>
									<option value="B">보통</option>
									<option value="C">이러다 죽겠다</option>
									<option value="F">재수강하자</option>
								</select>
							</div>
						</div>
	...
	<div class="modal fade" id="reportModal" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="reportAction.jsp" method="get">
